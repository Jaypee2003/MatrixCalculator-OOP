...
public class MultiplicationController extends MatrixBoxes{
    ...
    void performMatrixMultiplication(ActionEvent event) {
        ...
        boolean anyEmpty  = checkEmptyFields(matrixGridPaneA, matrixGridPaneB, rowsA, columnsA);
        if (anyEmpty) {
            validation1Text.setText("Please fill in all fields.");
            return;
        }
